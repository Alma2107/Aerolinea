    ...
    <div class="contenedor-asientos">
        <div class="main-content">
            <div class="card">
                ...
                <p class="info-pasajeros">Seleccioná una ubicación que acompañe mejor tu viaje: adelante, emergencia o estándar.</p>
                <div class="leyenda-cabina">
                    ...
                    <span class="leyenda-item"><span class="leyenda-color color-estandar"></span>Estándar</span>
        ...
        <aside class="sidebar-resumen">
            ...
            <hr class="separador">
            <p>Si querés una experiencia más visual, el próximo paso agrupa los datos del pasajero en tarjetas separadas.</p>
        </aside>
    </div>
</form>
<script>
